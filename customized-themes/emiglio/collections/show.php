...
<span class='st_sharethis'></span>
	...
	<!-- Added by Colleen -->
		<div class="element-text"><?php echo 'Total casualties posted to date:&nbsp;'. total_items_in_collection() .'.'; ?></div>
	<!-- End Added by Coleen -->
...
<div id="secondary">
    ...
    <p class="view-items-link"><?php echo link_to_browse_items('View all casualties from the ' . collection('Name'), array('collection' => collection('id'))); ?></p>
</div>
<?php foot();
